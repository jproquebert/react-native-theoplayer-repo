...
public class ReactTHEOplayerViewManager extends ViewGroupManager<ReactTHEOplayerView> {
  ...
  protected ReactTHEOplayerView createViewInstance(@NonNull ThemedReactContext reactContext) {
    return new ReactTHEOplayerView(reactContext, null);
  }

  @Override
  @NonNull
  public ReactTHEOplayerView createViewInstance(int reactTag,
                                                @NonNull ThemedReactContext reactContext,
                                                @Nullable ReactStylesDiffMap initialProps,
                                                @Nullable StateWrapper stateWrapper) {
    ReactTHEOplayerView view = new ReactTHEOplayerView(reactContext, initialProps);
    view.setId(reactTag);
  ...
  public void setConfig(final ReactTHEOplayerView videoView, @Nullable ReadableMap config) {
    // playerConfig is passed with initialProps as we need it during player creation.
  }
