...
public class ReactTHEOplayerView extends FrameLayout implements LifecycleEventListener {
  ...
  private static final String TAG = "ReactTHEOplayerView";
  ...
  public ReactTHEOplayerView(ThemedReactContext context, @Nullable ReactStylesDiffMap initialProps) {
    super(context);
    this.reactContext = context;
    this.eventEmitter = new VideoEventEmitter(context, this);
    createViews(PlayerConfigHelper.fromProps(initialProps != null ? initialProps.getMap(PROP_CONFIG) : null));
