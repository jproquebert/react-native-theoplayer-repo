...
class THEOplayerRCTView: UIView {
    ...
    // MARK: Bridged Events (not via listener)
    private var onNativeFullscreenPlayerWillPresent: RCTDirectEventBlock?
    private var onNativeFullscreenPlayerDidPresent: RCTDirectEventBlock?
    private var onNativeFullscreenPlayerWillDismiss: RCTDirectEventBlock?
    private var onNativeFullscreenPlayerDidDismiss: RCTDirectEventBlock?
    ...
    func setOnNativeFullscreenPlayerWillPresent(nativeFullscreenPlayerWillPresent: @escaping RCTDirectEventBlock) {
        self.onNativeFullscreenPlayerWillPresent = nativeFullscreenPlayerWillPresent
    ...
    func setOnNativeFullscreenPlayerDidPresent(nativeFullscreenPlayerDidPresent: @escaping RCTDirectEventBlock) {
        self.onNativeFullscreenPlayerDidPresent = nativeFullscreenPlayerDidPresent
    ...
    func setOnNativeFullscreenPlayerWillDismiss(nativeFullscreenPlayerWillDismiss: @escaping RCTDirectEventBlock) {
        self.onNativeFullscreenPlayerWillDismiss = nativeFullscreenPlayerWillDismiss
    ...
    func setOnNativeFullscreenPlayerDidDismiss(nativeFullscreenPlayerDidDismiss: @escaping RCTDirectEventBlock) {
        self.onNativeFullscreenPlayerDidDismiss = nativeFullscreenPlayerDidDismiss
